...
var G__8405 = request;
var G__8406 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__8405,G__8406) : ajax.formats.get_format.call(null,G__8405,G__8406));
} else {
...
return cljs.core.some((function (p1__8409_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__8409_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__8411){
var map__8412 = p__8411;
var map__8412__$1 = cljs.core.__destructure_map(map__8412);
var request = map__8412__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8412__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__8425 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__8425.cljs$core$IFn$_invoke$arity$1 ? fexpr__8425.cljs$core$IFn$_invoke$arity$1(response) : fexpr__8425.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__8431){
var map__8432 = p__8431;
var map__8432__$1 = cljs.core.__destructure_map(map__8432);
var request = map__8432__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8432__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__8427_SHARP_){
return ajax.formats.get_accept_entries(request,p1__8427_SHARP_);
