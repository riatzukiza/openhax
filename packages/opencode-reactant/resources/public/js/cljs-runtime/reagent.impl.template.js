...
var G__8972 = o;
reagent.impl.template.goog$module$goog$object.set(G__8972,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__9011 = o;
reagent.impl.template.goog$module$goog$object.set(G__9011,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__9252__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__9254__i < G__9254__a.length) {G__9254__a[G__9254__i] = arguments[G__9254__i + 0]; ++G__9254__i;}
  args = new cljs.core.IndexedSeq(G__9254__a,0,null);
} 
...
var G__9030 = props;
var G__9030__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__9030,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__9030);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__9030__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__9042 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__9042,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__9042;
}
})(),id_class);
...
var vec__9045 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9045,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9045,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9045,(2),null);
...
var temp__5808__auto___9276 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___9276 == null)){
} else {
var key_9278 = temp__5808__auto___9276;
(jsprops.key = key_9278);
}
...
var temp__5808__auto___9279 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___9279 == null)){
} else {
var key_9280 = temp__5808__auto___9279;
(jsprops.key = key_9280);
}
...
var temp__5808__auto___9283 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___9283 == null)){
} else {
var key_9284 = temp__5808__auto___9283;
(jsprops.key = key_9284);
}
...
var temp__5808__auto___9288 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___9288 == null)){
} else {
var key_9289 = temp__5808__auto___9288;
(jsprops.key = key_9289);
}
...
var temp__5808__auto___9291 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___9291 == null)){
} else {
var key_9294 = temp__5808__auto___9291;
(jsprops.key = key_9294);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__9118_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__9118_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__9153 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9153,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9153,(1),null);
...
*/
reagent.impl.template.t_reagent$impl$template9208 = (function (opts,id,fn_to_element,parse_fn,meta9209){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template9208.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_9210,meta9209__$1){
var self__ = this;
var _9210__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template9208(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta9209__$1));
}));

(reagent.impl.template.t_reagent$impl$template9208.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_9210){
var self__ = this;
var _9210__$1 = this;
return self__.meta9209;
}));

(reagent.impl.template.t_reagent$impl$template9208.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template9208.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template9208.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template9208.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template9208.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template9208.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta9209","meta9209",-976552498,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template9208.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template9208.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template9208");

(reagent.impl.template.t_reagent$impl$template9208.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template9208");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template9208.
 */
reagent.impl.template.__GT_t_reagent$impl$template9208 = (function reagent$impl$template$__GT_t_reagent$impl$template9208(opts,id,fn_to_element,parse_fn,meta9209){
return (new reagent.impl.template.t_reagent$impl$template9208(opts,id,fn_to_element,parse_fn,meta9209));
});
...
return (new reagent.impl.template.t_reagent$impl$template9208(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
